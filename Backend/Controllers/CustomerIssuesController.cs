...
public class CustomerIssuesController : ControllerBase
{
    ...
    public CustomerIssuesController(StoreFlowContext context, ICurrentUserService currentUser, IActivityLogService activityLog, INotificationService notifications)
    {
        _context = context;
