...
public class InventoryController : ControllerBase
{
    ...
    public InventoryController(StoreFlowContext context, ICurrentUserService currentUser, IActivityLogService activityLog, INotificationService notifications)
    {
        _context = context;
